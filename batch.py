...
11 IMPORTANT: The number of <audio> in the output is 5. If the number of <audio> is more than 1, each audio can focus on different images, but all audios together must cover ALL images.
...
13 IMPORTANT: The output content MUST reference EVERY audio tags using <audio1>, <audio2>, etc. format STRICTLY to create a cohesive narrative that ties together all the audio explanations. The output content MUST not contain the <image> tags of images in the output modal.
